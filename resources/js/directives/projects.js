angular.module('coala')
    .directive('projects', ['$http', '$timeout', '$location', 'Languages', 'orderByFilter', function ($http, $timeout, $location, Languages, orderByFilter) {
        return {
            restrict: 'E',
    ...
    .controller('ProjectController', function ($scope, $location, Languages, orderByFilter, $http, $timeout) {
        self = this
        $scope.message = {}
